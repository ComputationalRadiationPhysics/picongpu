...
from picongpu.picmi.diagnostics.openpmd_sources import Density
...
class PICMI_TestDensity(unittest.TestCase):
    def test_density_instantiation(self):
        """Test Density instantiation and validation."""
    ...
    def test_density_serialization(self):
        ...
        for params, expected_serialized in TESTCASES_VALID:
            with self.subTest(params=params, expected_serialized=expected_serialized):
                ...
                self.assertIsInstance(pypicongpu_source, PyPIConGPUDensity)
    ...
    def test_density_invalid_mapping(self):
        """Test Density with invalid species mapping."""
        for params, expected_error in TESTCASES_INVALID_MAPPING:
            with self.subTest(params=params, expected_error=expected_error):
                source = Density(species=params["species"], filter=params["filter"])
