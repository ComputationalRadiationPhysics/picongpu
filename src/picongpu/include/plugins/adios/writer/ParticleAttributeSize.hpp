...
struct ParticleAttributeSize
{
                            ...
                            const size_t globalOffset)
    {
        ...
        params.getInstance()->adiosGroupSize += elements * components * sizeof(ComponentType);
        ...
        for (uint32_t d = 0; d < components; d++)
        {
            ...
            datasetName << params.getInstance()->adiosBasePath << ADIOS_PATH_PARTICLES <<
            ...
            params.getInstance()->adiosParticleAttrVarIds.push_back(adiosParticleAttrId);
        }
