...
#ifndef LIVEVIEWMODULE_HPP
#define	LIVEVIEWMODULE_HPP
...
namespace picongpu
{
    ...
    class LiveViewModule : public IPluginModule
    {
    public:
        ...
        LiveViewModule(std::string name, std::string prefix) :
        analyzerName(name),
