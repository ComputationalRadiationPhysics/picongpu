...
namespace alpaka::rand::engine
{
    ...
    public:
        static constexpr std::uint64_t WEYL_64_0
            = 0x9E3779B97F4A7C15; ///< First Weyl sequence parameter: the golden ratio
        static constexpr std::uint64_t WEYL_64_1
            = 0xBB67AE8584CAA73B; ///< Second Weyl sequence parameter: \f$ \sqrt{3}-1 \f$

        static constexpr std::uint32_t WEYL_32_0 = high32Bits(WEYL_64_0); ///< 1st Weyl sequence parameter, 32 bits
        static constexpr std::uint32_t WEYL_32_1 = high32Bits(WEYL_64_1); ///< 2nd Weyl sequence parameter, 32 bits

        static constexpr std::uint32_t MULTIPLITER_4x32_0 = 0xCD9E8D57; ///< First Philox S-box multiplier
        static constexpr std::uint32_t MULTIPLITER_4x32_1 = 0xD2511F53; ///< Second Philox S-box multiplier
    };
} // namespace alpaka::rand::engine
