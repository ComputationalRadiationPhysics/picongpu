...
def main():
    ...
    parser.add_argument('dir', nargs='?',
                        help="simulation directory containing the simOutput "
                             "directory",
                        default=os.getcwd())
    parser.add_argument("--coulomb_log",
                        ...
                        type=float)
    parser.add_argument("--n_cells", help="number of cells to use to "
                                          "caluculate average values, "
                                          "by default all availible",
                        type=int)
