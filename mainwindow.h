...
public slots:
    ...
    void received_numCells(int numCells);
    void received_numParticles(int numParticles);
...
signals:
    ...
    void on_received_numCells(int numCells);
    void on_received_numParticles(int numParticles);
