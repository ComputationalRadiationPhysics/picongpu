#!/usr/bin/env bash
# Copyright 2013-2024 Axel Huebl, Richard Pausch, Rene Widera, Marco Garten
#
...
if [ $? -eq 0 ] ; then
  # Run PIConGPU
  source !TBG_dstPath/tbg/handleSlurmSignals.sh mpiexec -np !TBG_tasks "$EXE" !TBG_author !TBG_programParams
fi
