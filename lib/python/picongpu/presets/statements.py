...
def from_bash(cls, statement, regex):
...
class Statement(BaseModel):
    ...
    @classmethod
    def from_bash(cls, statement):
        return from_bash(cls, statement, cls._regex.default)
...
class AssignmentStatement(Statement):
    ...
    @classmethod
    def from_bash(cls, statement):
        tmp = from_bash(cls, statement, cls._regex.default)
...
def make_statement(statement):
    ...
    for StatementType in [AssignmentStatement, ModuleStatement, SourceStatement, LiteralCodeBlock]:
        try:
            return StatementType.from_bash(statement)
