...
class Auto(Plugin):
    ...
    This class requires a period (in time steps) and will enable as many output plugins as feasible for all species.
    Note: The list of species from the initmanager is used during rendering.
    No further configuration is possible!
    If you want to provide additional configuration for plugins, create a separate class.
    """
