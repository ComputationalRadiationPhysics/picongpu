...
from picongpu.plugins.data import XrayDiffractionData
import numpy as np
import matplotlib.pyplot as plt
from matplotlib.colors import LogNorm


# Visualize intensity output from X-ray diffraction plugin with matplotlib.
class Visualizer:
    def __init__(self, filename):
        self.data = XrayDiffractionData(filename)
