...
def assert_valid_input_file(directory, cleanup=True):
    ...
    if cleanup:
        # cleanup the temporary directory, because we do not need it anymore and it is not cleaned up automatically.
        directory.cleanup()

    required_lines = {
        " filename ": '"' + os.path.abspath(os.path.join(directory.name, "test_laser.bp")) + '"',
        " iteration ": "0",
        " datasetEName ": '"E"',
