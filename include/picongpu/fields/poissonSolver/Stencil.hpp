...
namespace picongpu::fields::poissonSolver
{
    struct StencilFunc
    {
        HDINLINE auto operator()(auto fieldIn) const
        {
            ...
            return stencilFunction(fieldIn, fc0, cellSizeSquared);
        }

        HDINLINE auto stencilFunction(
            auto fieldIn,
            float_64 const fc0,
            pmacc::math::Vector<float_X, 3u> const cellSizeSquared) const
        {
        ...
        HDINLINE auto stencilFunction(
            auto fieldIn,
            float_64 const fc0,
            pmacc::math::Vector<float_X, 2u> const cellSizeSquared) const
        {
    ...
    struct GetFieldEStencil
    {
        ...
        {
            constexpr auto cellSize = sim.pic.getCellSize().shrink<simDim>();
            return getFieldE(fieldIn, cellSize);
        }

        HDINLINE auto getFieldE(auto fieldIn, pmacc::math::Vector<float_X, 3u> const cellSize) const
        {
            float3_X eValue;
            constexpr DataSpace<3u> xDir(1, 0, 0);
            constexpr DataSpace<3u> yDir(0, 1, 0);
        ...
        HDINLINE auto getFieldE(auto fieldIn, pmacc::math::Vector<float_X, 2u> const cellSize) const
        {
            float3_X eValue;
            constexpr DataSpace<2u> xDir(1, 0);
            constexpr DataSpace<2u> yDir(0, 1);
