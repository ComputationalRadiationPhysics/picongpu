...
public:
    ...
    HDINLINE float_T
    calcBx_Linear_X( const float3_64& pos, const float_64 time ) const;
     ...
     *  for calculating the field */
    HDINLINE float_T
    calcBy_Linear_X( const float3_64& pos, const float_64 time ) const;
     ...
     *  for calculating the field */
    HDINLINE float_T
    calcBz_Linear_X( const float3_64& pos, const float_64 time ) const;
     ...
     *  for calculating the field */
    HDINLINE float_T
    calcBx_Linear_YZ( const float3_64& pos, const float_64 time ) const;
     ...
     *  for calculating the field */
    HDINLINE float_T
    calcBy_Linear_YZ( const float3_64& pos, const float_64 time ) const;
     ...
     *  for calculating the field */
    HDINLINE float_T
    calcBz_Linear_YZ( const float3_64& pos, const float_64 time ) const;
     ...
     * \return B-field vector of the rotated Gaussian laser field in SI units */
    HDINLINE float3_X
    getBfield_Normalized_Linear_YZ(
            const pmacc::math::Vector<floatD_64,detail::numComponents>& eFieldPositions_SI,
            const float_64 time) const;
