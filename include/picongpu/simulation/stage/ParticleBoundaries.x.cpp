...
namespace picongpu::simulation::stage
{
    namespace detail
    {
        ...
        public:
            ...
            {
                std::string prefix = T_Species::FrameType::getName();
            ...
            void operator()()
            {
                ...
                if(validateUserInputs)
                {
                    ...
                    for(uint32_t d = 0; d < simDim; d++)
                    {
                        ...
                        if(offset < 0)
                            throw std::runtime_error("Negative boundary offset " + errorString + " is not supported");
    ...
    void ParticleBoundaries::registerHelp(po::options_description& desc)
    {
