/* Copyright 2013-2023 Axel Huebl, Heiko Burau, Rene Widera, Felix Schmitt, Alexander Debus
 *
    ...
    private:
        ...
        void getCurrentSlideInfo(uint32_t currentStep, bool* doSlide, float_64* offsetFirstGPU)
        {
            ...
            if(slidingWindowEnabled)
            {
                ...
                const float_64 deltaWayPerStep = (windowMovingSpeed * float_64(sim.pic.getDt()));
