...
namespace picongpu::particles::debyeLength
{
    ...
    void check()
    {
        ...
        GridLayout<simDim> layout(localDomSize, GuardSize::toRT() * SuperCellSize::toRT());
        MappingDesc cellDescription = MappingDesc{layout.sizeND(), DataSpace<simDim>(GuardSize::toRT())};
