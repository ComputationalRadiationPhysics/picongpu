...
namespace beam
{
    ...
    {
        DataSpace< DIM3 >  globalDomainSize = Environment< DIM3 >::get(
    ...
    {
        auto  globalDomainSize = Environment< DIM2 >::get( ).SubGrid(
            ).getGlobalDomain().size;
        return float3_X(
            globalDomainSize[ 0 ],
            globalDomainSize[ 1 ],
            0.0
