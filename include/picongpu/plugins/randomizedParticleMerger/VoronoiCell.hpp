...
namespace randomizedParticleMerger
{
    ...
    struct VoronoiCell
    {
        ...
        )
        {
            ...
            {
                cupla::atomicAdd( acc, &this->meanPositionValue[i], weighting * position[i], ::alpaka::hierarchy::Threads{} );
            ...
            {
                cupla::atomicAdd( acc, &this->meanMomentumValue[i], weighting * momentum[i], ::alpaka::hierarchy::Threads{} );
                cupla::atomicAdd( acc, &this->meanMomentumSquaredValue[i], weighting * momentum2[i], ::alpaka::hierarchy::Threads{} );
            }
        }
